...
$target_file = $validation_data['key'];
 ...
 * @param string $file_check_value
 *
 * @return string
 */
function check_is_allowed_type( string $target_file_name, string $file_check_value ): string {
...
/**
 * @param $file_size
 * @param $file_check_value
 *
 * @return string
 */
function check_file_size( $file_size, $file_check_value ): string {
